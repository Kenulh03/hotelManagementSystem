...
public class RoomTypeEntity {
    ...
    public RoomTypeEntity(String roomTypeId, String roomType, Double roomTypePrice) {
    ...
    public String toString() {
        return "RoomTypeEntity{" + "roomTypeId=" + roomTypeId + ", roomType=" + roomType + ", roomTypePrice=" + roomTypePrice + '}';
    }
