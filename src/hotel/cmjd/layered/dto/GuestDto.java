...
public class GuestDto {
    ...
    public GuestDto(String guestId, String guestFirstName, String guestLastName, String guestAddress, String passportNumber, String guestCountry, String guestContact) {
    ...
    public String toString() {
        return "GuestDto{" + "guestId=" + guestId + ", guestFirstName=" + guestFirstName + ", guestLastName=" + guestLastName + ", guestAddress=" + guestAddress + ", passportNumber=" + passportNumber + ", guestCountry=" + guestCountry + ", guestContact=" + guestContact + '}';
    }
